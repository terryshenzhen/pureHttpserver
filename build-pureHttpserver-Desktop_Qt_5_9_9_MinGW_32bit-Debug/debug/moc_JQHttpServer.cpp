...
#include "../../pureHttpserver/library11/JQLibrary/include/JQHttpServer.h"
...
QT_MOC_LITERAL(4, 54, 12) // "deinitialize"

    },
    "JQHttpServer::AbstractManage\0readyToClose\0"
    "\0initialize\0deinitialize"
};
#undef QT_MOC_LITERAL
...
void JQHttpServer::AbstractManage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->initialize();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: _t->deinitialize(); break;
        default: ;
        }
